...
export const SignUpCard = ({ setState }: SignUpCardProps) => {
    ...
    const [confromPassword, setComfromPassword] = useState("")
    return (
        <Card className="w-full h-full p-8">
            ...
            <CardContent className="space-y-5 px-0 pb-0">
                ...
                <form className="space-y-2.5">
                    <Input disabled={false} value={confromPassword} onChange={(e) => setComfromPassword(e.target.value)} placeholder="Conform Password" type="password" required />
                </form>
